...
// ADDED FUNCTIONS
/**
 * return a river hand indexer
 */
hand_indexer_t* river_indexer_init();

/**
 * return an array of cards for an index
 */
uint8_t get_cards(const hand_indexer_t * indexer, uint_fast32_t round, hand_index_t index);
// !ADDED FUNCTIONS
